const mm2Items = [
  ...
  // Sailor Piece (Peça de Marinheiro)
  { id: 1001, name: "350X COSMETIC CRATE - [CAIXA COSMÉTICA]", price: 17.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/cosmetic-crate.png" },
  { id: 1002, name: "700X COSMETIC CRATE - [CAIXA COSMÉTICA]", price: 23.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/cosmetic-crate.png" },
  { id: 1003, name: "5.000X COSMETIC CRATE - [CAIXA COSMÉTICA]", price: 54.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/cosmetic-crate.png" },
  { id: 1004, name: "250X LEGENDARY CHEST - [CAIXA LENDÁRIA]", price: 10.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/legendary-chest.png" },
  { id: 1005, name: "500X LEGENDARY CHEST - [CAIXA LENDÁRIA]", price: 14.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/legendary-chest.png" },
  { id: 1006, name: "1.000X LEGENDARY CHEST - [CAIXA LENDÁRIA]", price: 23.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/legendary-chest.png" },
  { id: 1007, name: "5.000X LEGENDARY CHEST - [CAIXA LENDÁRIA]", price: 94.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/legendary-chest.png" },
  { id: 1008, name: "THE WORLD - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 82.19, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/the-world.png" },
  { id: 1009, name: "THE WORLD + WORLD OUTFIT - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 71.89, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/the-world-outfit.png" },
  { id: 1010, name: "THE WORLD + COSMIC BEING + GREAT MAGE - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 159.44, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/cosmic-being.png" },
  { id: 1011, name: "ATOMIC - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 79.62, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/atomic.png" },
  { id: 1012, name: "ABYSSAL EMPRESS + ATOMIC - [IMPERATRIZ ABISSAL/ATÔMICO] - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 131.16, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/abyssal-empress.png" },
  { id: 1013, name: "BLESSED MAIDEN - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 74.47, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/blessed-maiden.png" },
  { id: 1014, name: "BLESSED MAIDEN + YAMATO - [DONZELA ABENÇOADA] - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 123.39, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/yamato.png" },
  { id: 1015, name: "YAMATO - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 69.32, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/yamato.png" },
  { id: 1016, name: "DEMON KING - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 69.32, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/demon-king.png" },
  { id: 1017, name: "DEMON KING + SHADOW MONARCH - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 118.24, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/shadow-monarch.png" },
  { id: 1018, name: "SIN OF PRIDE [ESCANOR] - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 69.35, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/sin-of-pride.png" },
  { id: 1019, name: "SIN OF PRIDE + SUN ARMOR - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 64.17, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/sun-armor.png" },
  { id: 1020, name: "KING OF HEROES [GILGAMESH] - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 53.87, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/king-of-heroes.png" },
  { id: 1021, name: "KING OF HEROES + GATE OF BABYLON - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 77.04, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/gate-of-babylon.png" },
  { id: 1022, name: "QIN SHI - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 48.72, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/qin-shi.png" },
  { id: 1023, name: "QIN SHI + MANIPULATOR - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 74.47, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/manipulator.png" },
  { id: 1024, name: "SOLO HUNTER - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 51.29, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/solo-hunter.png" },
  { id: 1025, name: "SOLO HUNTER + HUNTER CAPE - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 48.72, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/hunter-cape.png" },
  { id: 1026, name: "SHADOW - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 56.44, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/shadow.png" },
  { id: 1027, name: "SHADOW + SHADOW CLOAK - GAME PASS ATIVADA NA SUA CONTA, SEM MISSÃO!", price: 53.87, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/shadow-cloak.png" },
  { id: 1028, name: "STRONGEST IN HISTORY - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 61.59, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/strongest-in-history.png" },
  { id: 1029, name: "CONQUEROR HAKI - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 56.44, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/conqueror-haki.png" },
  { id: 1030, name: "VAMPIRE KING - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 51.29, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/vampire-king.png" },
  { id: 1031, name: "CURSED KING - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 46.33, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/cursed-king.png" },
  { id: 1032, name: "LIMITLESS SORCERER - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 40.95, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/limitless-sorcerer.png" },
  { id: 1033, name: "CURSED VESSEL - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 30.68, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/cursed-vessel.png" },
  { id: 1034, name: "EXCALIBUR - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 30.69, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/excalibur.png" },
  { id: 1035, name: "SOUL REAPER - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 51.29, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/soul-reaper.png" },
  { id: 1036, name: "MANIPULATOR - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 53.87, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/manipulator.png" },
  { id: 1037, name: "SLIME - GAME PASS NA SUA CONTA, SEM MISSÃO!", price: 64.17, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/slime.png" },
  { id: 1038, name: "2.000X DARK GRAIL - [GRAAL SOMBRIO]", price: 12.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/dark-grail.png" },
  { id: 1039, name: "2.000X ABYSS SIGIL - [SELO DO ABISMO]", price: 12.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/abyss-sigil.png" },
  { id: 1040, name: "1.000X BOSS TICKET - [INGRESSO DO CHEFE]", price: 9.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/boss-ticket.png" },
  { id: 1041, name: "2.500X DUNGEON KEY - [CHAVE DE MASMORRA]", price: 12.90, category: "Sailor Piece", image: "https://cdn.bloxvendas.com.br/products/dungeon-key.png" },
];
